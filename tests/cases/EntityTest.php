...
class EntityTest extends PHPUnit_Framework_TestCase
{
     ...
     *
     * @expectedException        Exception
     * @expectedExceptionMessage Type '99' is unknown.
     */
     ...
     *
     * @expectedException        Exception
     * @expectedException Message ID is missing.
     */
     ...
     *
     * @expectedException        Exception
     * @expectedExceptionMessage Address must be an instance of class 'ComprobanteElectronico\Data\Address'.
     */
     ...
     *
     * @expectedException        Exception
     * @expectedExceptionMessage Phone must be an instance of class 'ComprobanteElectronico\Data\Phone'.
     */
     ...
     *
     * @expectedException        Exception
     * @expectedExceptionMessage Fax must be an instance of class 'ComprobanteElectronico\Data\Phone'.
     */
